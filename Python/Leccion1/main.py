...
z = x + y 
print(id(x))
# Las literales se escriben x768, la varible y = x512, la varible z = x832
print(id(y))
print(id(z))
...
# Manejo de cadenas
miGrupoFavorito = "Los iracundos:"
caracteristicas = "El mejor grupo"
...
if (20 <= edad < 30) or (30 <= edad < 40):  # Sintaxis simplificadas del operador and
